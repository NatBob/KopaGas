...
public class Vendor_Stats extends AppCompatActivity {
    ...
    private void displayBrands(){
        Intent vendorIntent= new Intent(Vendor_Stats.this, GasDetail.class);
    ...
    public void vendorLogin(){
        Intent vendorIntent= new Intent(Vendor_Stats.this, LandingPage.class);
        startActivity(vendorIntent);
        Log.i("Vendor Register","View to All Vendors");
    }
    private void editBrand() {
        Intent vendorIntent= new Intent(Vendor_Stats.this, VendorDash.class);
        startActivity(vendorIntent);
        Log.i("MainActivity","View Local Vendors");
    }
    private void Signin(){
        Intent vendorIntent= new Intent(Vendor_Stats.this, ViewVendors.class);
        startActivity(vendorIntent);
