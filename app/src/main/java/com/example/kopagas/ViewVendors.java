...
public class ViewVendors extends AppCompatActivity {
    private static final String TAG = "OkoaVendor";
    ...
    private String user = SharedPrefManager.fetchUser();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Gas Vendors");

        vendors = new ArrayList<>();
        recyclerViewUsers = (RecyclerView) findViewById(R.id.recyclerViewUser);
        recyclerViewUsers.setHasFixedSize(true);
        recyclerViewUsers.setLayoutManager(new LinearLayoutManager(ViewVendors.this));
        ...
        call.enqueue(new Callback<List<Vendor>>() {
            ...
            public void onResponse(Call<List<Vendor>> call, Response<List<Vendor>> response) {
                if (response.isSuccessful()) {
                    vendors = (List<Vendor>) response.body();
                    ...
                    Log.e(TAG, "Failed Display = " + vendors);
    ...
    public void vendorLogin(){
        Intent vendorIntent= new Intent(ViewVendors.this, GasDetail.class);
        startActivity(vendorIntent);
