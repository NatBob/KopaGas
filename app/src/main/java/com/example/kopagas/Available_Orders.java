...
public class Available_Orders extends AppCompatActivity {
    ...
    private void displayBrands(){
        Intent vendorIntent= new Intent(Available_Orders.this, GasDetail.class);
    ...
    public void vendorLogin(){
        Intent vendorIntent= new Intent(Available_Orders.this, LandingPage.class);
        startActivity(vendorIntent);
        Log.i("Vendor Register","View to All Vendors");
    }
    private void editBrand() {
        Intent vendorIntent= new Intent(Available_Orders.this, ViewVendors.class);
        startActivity(vendorIntent);
